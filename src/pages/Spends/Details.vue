    ...
    <card>
      <template slot="header">
        <h4 class="card-title">
          ...
          <base-button type="twitter" size="lg" v-print="'#Print'"
      ...
      <div class="row">
        <div class="col-ms-12 col-md-5">
          <h4 slot="header" class="card-title">Datos de la Compra</h4>
          <div class="row">
        ...
        <div class="row col-ms-12 col-md-7" style="border-left: solid">
          <div class="col-12">
            <h4 slot="header" class="card-title text-center">Detalle</h4>
            <div>
              <div
      ...
      <div id="Print" class="bg-white h-100 imprimir">
        <div class="row w-100">
          <img
            ...
            style="height: 150px; margin-left: 5%"
          ...
          <div class="col-12">
            ...
            <div class="col-12 text-right">
              Sub Total: {{ gastos.subTotal.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Itbis: {{ gastos.itbis.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
            ...
            <hr />
            <div class="col-12 text-right">
              ISR:{{ gastos.totalRetenciones.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Monto Pagado:{{ gastos.montoPagar.toFixed(2) }}
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  async mounted() {
    ...
    axios.get(this.baseApiUrl + 'gastos/' + this.id).then((reponse) => {
      this.gastos = reponse.data
      reponse.data.detalleRetenciones.forEach((element) => {
        element.retenciones = element.retenciones.descripcion
