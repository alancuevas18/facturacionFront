<template>
  <div class="content">
    ...
    <div class="col-md-8 ml-auto mr-auto">
      <h2 class="text-center">{{ $t('spendsType.index') }}s</h2>
    </div>
    <div class="row mt-5">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title">
            {{ $t('spendsType.spendsType') }}
            <router-link to="/spendsType/create">
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.isLoading = true
      axios
        .delete(this.baseApiUrl + 'TipoGastos/' + row.id)
        .then(() => {
  ...
  mounted() {
    ...
    axios
      .get(this.baseApiUrl + 'TipoGastos')
      .then((response) => {
