  ...
  <div class="col-md-12">
    ...
    <card>
      <template slot="header">
        <h4 class="card-title">
          ...
          <div class="input-group mb-3">
            <el-select class="select-primary" size="large" v-model="impresora">
              <el-option
            ...
            <div class="input-group-append">
              <base-button type="twitter m-0" v-print="'#Print'">
      ...
      <div class="col-ms-12 col-md-12">
        <h4 slot="header" class="card-title">Datos del Cuadre</h4>
        <div class="row">
          <div class="col-ms-12 col-md-6">
            <label class="col-form-label"
              >Sucursal: {{ cuadreSucursal.sucursales }}</label
            >
          </div>
          <div class="col-ms-12 col-md-6">
            <label class="col-form-label"
              >Usuario: {{ cuadreSucursal.usuarios }}</label
            >
          </div>
          <div class="col-ms-12 col-md-6">
            <label class="col-form-label"
              >Fecha: {{ cuadreSucursal.fecha }}</label
            >
          </div>
          <div class="col-ms-12 col-md-6">
            <label class="col-form-label"
              >Turno: {{ cuadreSucursal.turnoId }}</label
            >
          </div>
          <table class="table">
            <thead>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(this.baseApiUrl + 'CuadreSucursal/' + this.id)
      .then((response) => {
