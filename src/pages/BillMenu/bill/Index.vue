<template>
  <div class="content">
    ...
    <div class="col-12">
      ...
      <div
        class="col-md-4 col-ms-12 modalsearch container"
        v-if="ver_popup_search"
      >
        <div class="row m-1">
          <div class="col-11 text-center">{{ titleModal }}</div>
          <div class="col-1">
            <i class="fa-solid fa-xmark" @click="ver_popup_search = false"></i>
          </div>
        </div>
        <div class="col-12">
                  ...
                  <i
                    ...
                    @click="
                      ;(ver_popup_search = false),
                        (currentCode.codigo = item.codigo)
                    "
                  ></i>
                </td>
              </tr>
      ...
      <card>
          ...
          <div class="col-md-4 col-ms-12" v-if="!pagodo">
            <div class="container">
              <base-button
                ...
                :class="
                  formToAddProducts
                    ? 'btn animation-on-hover btn-info'
                    : 'btn btn-link'
                "
                size="sm"
          ...
          <div :class="pagodo ? 'col-md-12' : 'col-md-8 col-ms-12 '">
            <div class="row">
              <div class="h3 col-12" style="margin-bottom: -10px">
                <a @click="menuOption = !menuOption">
                  <i class="fa-solid fa-sliders text-white"></i
                ></a>
                <div
                  class="ml-2 h3 position-absolute rounded-lg row"
                  style="
                    z-index: 15;
                ...
                >
                  <div class="col-12">
                    <base-checkbox v-model="Vendedor"> Vendedor </base-checkbox>
                  </div>
                  <div class="col-12">
            ...
            <card card-body-classes="table-full-width">
              <div>
                ...
                ></div>
                <div
                  class="tableFixHead scroll scroll-white mt-2 tableFixHead2"
                  id="tableProducto"
                >
              ...
              >
                ...
                <div
                  class="col-12 justify-content-center align-items-centerm d-flex"
                  v-if="!pagodo"
                >
                  <div class="col-12">
                    <base-button
                      ...
                      ><i class="fa-solid fa-money-check-dollar display-4"></i>
                      Facturar</base-button
                    >
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div
            class="col-12 row"
            v-if="pagodo && pendiente > 0 && bill.tipoFactura == 1"
          >
            <div class="col-md-3">
              <base-button
                type="youtube"
                ...
                ><i class="fa-solid fa-money-bill display-4"></i>
                Efectivo</base-button
              >
            </div>
            <div class="col-md-3">
              <base-button
              ...
              >
                <i class="fa-solid fa-money-bill-transfer display-4"></i>
                Tranferencia</base-button
              >
            </div>
            <div class="col-md-3">
              <base-button
              ...
              >
                <i class="fa-solid fa-credit-card display-4"></i>
                Tarjeta</base-button
              >
            </div>
            <div class="col-md-3">
              ...
              >
                <i class="fa-solid fa-comments-dollar display-4"></i>Nota
                Credito</base-button
              >
            </div>
          </div>
          ...
          <div
            class="col-12 row"
            v-if="pagodo && (pendiente <= 0 || bill.tipoFactura == 2)"
          >
            <div class="col-md-4 col-ms-12">
              <base-button
                ...
                size="lg"
                v-print="'#Print'"
                ><i class="fa-solid fa-print display-4"></i>
                Imprimir</base-button
              >
            </div>
            <div class="col-md-4 col-ms-12">
              <router-link
                to="/billDashboard/bill/index"
                @click.native="$router.go()"
              >
                <button class="btn btn-lg btn-youtube w-100">
                  <i class="fa-solid fa-file-invoice display-4"></i> Generar
                  nueva Factura
                </button>
              </router-link>
            </div>
            <div class="col-md-4 col-ms-12">
              <base-button
                class="w-100 btn btn-lg btn-green"
                size="lg"
                @click="ver_popup_send = !ver_popup_send"
                ><i class="fa-solid fa-truck display-4"></i> Enviar</base-button
              >
            </div>
          </div>
        </div>
    ...
    <!-- modal pay -->
    <div
      class="col-md-4 col-ms-12 modalpay container"
      :class="'modal-' + titleModalPay"
      v-if="ver_popup_pay && pendiente > 0"
    >
      <div class="row mt-3">
        <div class="col-10 display-4 text-center">
          Realizar pago {{ titleModalPay }}
        </div>
        <div class="col-2 h2 text-white">
          <base-button type="link" @click.native="ver_popup_pay = false">
            <i class="fa-solid fa-xmark display-4 text-white"></i
          ></base-button>
        </div>
      </div>
    ...
    <!-- Send Bill Modal -->
    <div
      class="col-md-4 col-ms-12 modalsend container modal-send"
      v-if="ver_popup_send"
    >
      <div class="row mt-3">
        <div class="col-10 display-4 text-center">Enviar factura</div>
        <div class="col-2 h2 text-white">
          <base-button type="link" @click.native="ver_popup_send = false">
            <i class="fa-solid fa-xmark display-4 text-white"></i
          ></base-button>
        </div>
      </div>
      <div class="col-12 row mt-3">
        <label class="col-form-label">Cliente </label>
        <base-input v-model="send.cliente"> </base-input>
      </div>

      <div class="col-12 row mt-3">
        <label class="col-form-label">Numero Contacto </label>
        <base-input v-model="send.numeroContacto"> </base-input>
      </div>

      <div class="col-12 row mt-3">
        <label class="col-form-label">Direccion </label>
        <base-input v-model="send.direccion"> </base-input>
      </div>

      <div class="col-12 row mt-3">
        <label class="col-form-label">Fecha Envio </label>
        <base-input type="date" v-model="send.fechaEnvio"> </base-input>
      </div>

      <div class="col-12 row mt-3">
        <label class="col-form-label">Fecha Entrega </label>
        <base-input type="date" v-model="send.fechaEntrega"> </base-input>
      </div>
      ...
      <div class="col-12 row mt-1">
        <label class="col-form-label">Mensajero</label>
        <el-select
          required
          filterable
          class="select-primary w-100"
      ...
      <div class="col-12 row mt-1">
        <label class="col-form-label">Estado Envio</label>
        <el-select
          required
          filterable
          class="select-primary w-100"
      ...
      <div class="col-md-12 mt-2">
        <base-button
          ...
          class="w-100"
          size="lg"
          @click.native="createSend()"
          ><i class="fa-solid fa-truck display-4"></i> Completar
          Envio</base-button
        >
      </div>
    </div>
    ...
    <div class="container d-none">
      <div id="Print" class="bg-white h-100">
        <div class="row">
          ...
          <div class="col-12">
            Ubicación: {{ facturas.sucursales.ubicacion }}
          </div>
          ...
          <div class="col-12">
            ...
            <div class="col-12 text-right">
              Descuento: {{ facturas.descuento.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Sub Total: {{ facturas.subTotal.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Itbis: {{ facturas.itbis.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Total:{{ facturas.total.toFixed(2) }}
            </div>
            <hr />
            <div class="col-12 text-right">
              Monto Pagado:{{ facturas.abono.toFixed(2) }}
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    descuento() {
      this.bill.descuento = this.tableData
        .map((c) => c.descuento)
        .reduce((a, b) => a + b, 0)
      return this.bill.descuento
    },
    itbis() {
      this.bill.itbis = this.tableData
        .map((c) => c.itbis)
        .reduce((a, b) => a + b, 0)
      return this.bill.itbis
    },
    subtotal() {
      this.bill.subTotal = this.tableData
        .map((c) => c.precio * c.cantidad)
        .reduce((a, b) => a + b, 0)
      return this.bill.subTotal
    },
    total() {
      this.bill.total = this.tableData
        .map((c) => c.total)
        .reduce((a, b) => a + b, 0)
    ...
    pendiente() {
      return (
        this.tableData.map((c) => c.total).reduce((a, b) => a + b, 0) -
        this.bill.abono
      )
    }
  },
  ...
  mounted() {
    ...
    axios.get(this.baseApiUrl + 'Turnos/TurnoByUserOpen').then((response) => {
  ...
  methods: {
    changeShowForm(item) {
      ...
      if (item == 'Producto') this.formToAddProducts = true
      else this.formToAddProducts = false
    },
    checkIn() {
      this.readOnly = true
      this.pagodo = true
    ...
    paying() {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (this.bill.total <= this.bill.abono) this.loadBill()
        })
        .catch((error) => {
          this.globalSweetMessage(error.response.data.message, 'error')
        })
    ...
    pickProduct() {
      ...
      axios
        ...
        .then((response) => {
          ...
          itbis = toFixedNumber(
            (response.data.precio * this.currentCode.quanty - descuento) *
              this.currentCode.tax,
            2
          )
          total = toFixedNumber(
            response.data.precio * this.currentCode.quanty + itbis - descuento,
            2
          )
          subTotal = toFixedNumber(
            response.data.precio * this.currentCode.quanty - descuento,
            2
          )
          if (AddedProduct >= 0) {
            ...
            if (!this.validateQuanty(quanty, response.data.stock)) return false
            ...
            subTotal = toFixedNumber(
              this.tableData[AddedProduct].precio * quanty,
              2
            )
            itbis = toFixedNumber(
              (subTotal - descuento) * this.currentCode.tax,
              2
            )
            this.tableData[AddedProduct].cantidad = quanty
            this.tableData[AddedProduct].itbis = itbis
            this.tableData[AddedProduct].total = toFixedNumber(
    ...
    subgetModal(item) {
      axios.get(this.baseApiUrl + item + 'Sucursales').then((response) => {
    ...
    filterProduct() {
      this.tableDataProducFilter = this.tableDataProduc.filter((c) =>
        c.nombre.toLowerCase().includes(this.search.toLowerCase())
      )
    },
    createSend() {
      this.isLoading = true
      this.send.facturaId = this.pay.facturaId
      axios
        .post(this.baseApiUrl + 'Envios', this.send)
        .then((response) => {
          this.globalSweetMessage(response.data.message)
          this.ver_popup_send = false
        })
        .catch((error) => {
          this.globalSweetMessage(error.response.data.message, 'error')
        })
