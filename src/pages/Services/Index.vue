            ...
            <el-table :data="queriedData">
              ...
              <el-table-column :min-width="135" align="right" label="Actions">
                <div slot-scope="props">
                  <router-link :to="'/services/create/' + props.row.id">
                    <base-button
                      class="edit btn-link"
                      type="warning"
                      size="sm"
...
export default {
  ...
  data() {
    return {
      ...
      brands: {},
      searchQuery: '',
      propsToSearch: ['codigo', 'nombre', 'descripcion'],
      tableColumns: [
        {
          prop: 'codigo',
          label: 'Codigo',
  ...
  methods: {
    ...
    deleteRow(row) {
      this.isLoading = true
      axios
        .delete(this.baseApiUrl + 'servicios/' + row.id)
        .then(() => {
