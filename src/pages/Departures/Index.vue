<template>
  <div class="content">
    ...
    <div class="col-md-8 ml-auto mr-auto">
      <h2 class="text-center">{{ $t('departures.index') }}</h2>
    </div>
    <div class="row mt-5">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title">
            ...
            <router-link to="/departures/create">
            ...
            <el-table :data="queriedData">
              ...
              <el-table-column :min-width="135" align="right" label="Actions">
                <div slot-scope="props">
                  <router-link :to="'/departures/details/' + props.row.id">
                    <base-button
                      class="like btn-link"
                      type="info"
                      size="sm"
                  ...
                  <router-link :to="'/departures/create/' + props.row.id">
                    <base-button
                      class="edit btn-link"
                      type="warning"
                      size="sm"
