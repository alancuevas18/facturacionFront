<template>
  <div class="content">
    ...
    <div class="col-md-8 ml-auto mr-auto">
      <h2 class="text-center">{{ $t('services.byOffice') }}</h2>
    </div>
    <div class="row mt-5">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title">
            {{ $t('services.services') }}
            <router-link to="/servicesoffice/create">
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                ><button
                  @click="fillTable('serviciossucursales', true)"
            ...
            <el-table :data="queriedData">
              ...
              <el-table-column :min-width="135" align="right" label="Actions">
                <div slot-scope="props">
                  <router-link :to="'/servicesoffice/create/' + props.row.id">
                    <base-button
                      class="edit btn-link"
                      type="warning"
                      size="sm"
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.isLoading = true
      axios
        .delete(this.baseApiUrl + 'serviciossucursales/' + row.id)
        .then(() => {
  ...
  mounted() {
    ...
    this.fillCatalog()
    this.fillTable('serviciossucursales', true)
  },
  watch: {}
}
</script>
